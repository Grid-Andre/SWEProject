...
class FromAppData(BaseEmbed):
    ...
    def add_parser_arguments(cls, parser, interpreter):
        ...
        parser.add_argument(
            ...
            dest="clear_app_data",
            action="store_true",
            help="clear the application data folder of seed images ({})".format((default_data_dir() / "seed-v1").path),
            default=False,
        )
        can_symlink = fs_supports_symlink()
        parser.add_argument(
            "--symlink-application-data",
            dest="symlink_app_data",
            action="store_true" if can_symlink else "store_false",
            help="{} symlink the python packages from the application-data folder (requires seed pip>=19.3)".format(
