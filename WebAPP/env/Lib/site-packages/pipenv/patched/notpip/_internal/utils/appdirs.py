...
def user_cache_dir(appname):
    ...
    non-roaming application data dir (the default returned by `user_data_dir`). Apps
    ...
    if WINDOWS:
        ...
        # Add our application name and Cache directory to it
        path = os.path.join(path, appname, "Cache")
    elif sys.platform == "darwin":
        # Get the base path
        path = expanduser("~/Library/Caches")

        # Add our application name to it
