...
class CSRFProtect(object):
    """Enable CSRF protection globally for a Flask application.
    ...
    def exempt(self, view):
        ...
        ::
            ...
            @application.route('/some-view', methods=['POST'])
            @csrf.exempt
            def some_view():
                ...
    ...
    def error_handler(self, view):
        ...
        .. deprecated:: 0.14
            ...
            ``@application.errorhandler(CSRFError)`` instead. This will be removed in
            version 1.0.
        ...
        warnings.warn(FlaskWTFDeprecationWarning(
            ...
            'error system with "@application.errorhandler(CSRFError)" instead. This '
