...
def fitness():
    ...
    if form.validate_on_submit():
        ...
        if weight < 155 and exercise == "Weights":
            ...
            return render_template('/fitness/exercise.html', form=form, calories=calories, value=data)
        ...
        return render_template('/fitness/exercise.html', form=form, value=data, weight=weight, time=time)

    return render_template('/fitness/exercise.html', form=form)


@app.route('/calFitness', methods=['GET', 'POST'])
def cal():
    return render_template('/fitness/cal.html')
